                    ...
                    <div class="card-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Fish Info</a></li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel33">Table Fish Info</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="tgl_publikasi" name="tgl_publikasi"  required>
                                                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <?php
                                    ...
                                    $options = array(
                                        CURLOPT_URL => 'https://ap-southeast-1.aws.data.mongodb-api.com/app/application-0-bcdsp/endpoint/getFishInfo',
                                    ...
                                    foreach ($data as $row) :
                                        echo '<tr>
                                                <td>'.(empty($row->judul) ? '' : $row->judul).'</td>';
                                    
                                            // Debugging statement
                                            if (!is_string($row->deskripsi)) {
                                                echo '<td>Deskripsi is not a string: ' . gettype($row->deskripsi) . '</td>';
                                            } else {
                                                echo '<td>'.(empty($row->deskripsi) ? '' : substr($row->deskripsi, 0, 200)).'</td>';
                                            }
                                    
                                        echo '<td>';
                                            if (!empty($row->gambar)) {
                                                if (is_string($row->gambar)) {
                                                    echo '<img src="/assets/img/artikel/' . $row->gambar . '" width="100" height="100">';
                                                } else {
                                       ...
                                       echo '<td>';
                                            if (!empty($row->tgl_publikasi)) {
                                                if (is_string($row->tgl_publikasi)) {
                                                    echo $row->tgl_publikasi;
                                                } else {
                                        ...
                                        echo '<td>
                                                ...
                                                <td>
                                                <form action="'.route('deleteFishinfo', ['id' => $row->_id]).'" method="POST">
                    ...
                    <div class="modal fade" id="modalArtikel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formArtikel" action="{{ route('admin.updatefishinfo') }}" method="post" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="mb-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit').click(function() {
                ...
                $.ajax({
                    url: 'https://ap-southeast-1.aws.data.mongodb-api.com/app/application-0-bcdsp/endpoint/getArtikelById?id=' + id,
                    type: 'GET',
