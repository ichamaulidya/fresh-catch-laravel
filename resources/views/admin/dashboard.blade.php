        ...
        <div id="main">
            ...
            <div class="container mb-4">
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-3 offset-md-3 offset-lg-5 position-relative">
                        <div class="card position-absolute top-0">
            ...
            <div class="page-content">
                <section class="row mt-10 justify-content-between">
                            ...
                            <div class="card-body px-4 py-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Today's Money</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Our Partner</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Fish Info</h6>
                    ...
                    <div class="col-6 col-lg-3 col-md-6 mt-auto">
                        <div class="card">
                            <div class="card-body px-4 py-3">
                                <div class="row">
                                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo (empty($row->nama_produk) ? '' : $row->nama_produk); ?></td>
                                        <td><?php echo (empty($row->harga) ? '' : 'Rp. ' . $row->harga); ?></td>
                                        <td>
                                            <?php
                                                if (!empty($row->dibuat)) {
