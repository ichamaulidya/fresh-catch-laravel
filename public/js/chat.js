$(document).ready(function () {
	$.ajax({
		url: "https://asia-south1.gcp.data.mongodb-api.com/app/application-0-cbxcb/endpoint/getAllPenggunaLainnya",
		type: "GET",
		data: {
			// penerima: "admin",
	...
	function load_chat() {
		$.ajax({
			url: "https://asia-south1.gcp.data.mongodb-api.com/app/application-0-cbxcb/endpoint/getObrolanByPengirimPenerima",
			type: "GET",
			data: {
	...
	$("#form-send").submit(function () {
		$.ajax({
			url: "https://asia-south1.gcp.data.mongodb-api.com/app/application-0-cbxcb/endpoint/postObrolan",
			type: "POST",
			data: {
